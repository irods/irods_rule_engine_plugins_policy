...
def query_iterator_configured(arg=None):
    ...
    with lib.file_backed_up(filename):
        ...
        irods_config.server_config['plugin_configuration']['rule_engines'].insert(0,
           {
                "instance_name": "irods_rule_engine_plugin-policy_engine-query_iterator-instance",
                "plugin_name": "irods_rule_engine_plugin-policy_engine-query_iterator",
                "plugin_specific_configuration": {
                    "log_errors" : "true"
                }
           }
